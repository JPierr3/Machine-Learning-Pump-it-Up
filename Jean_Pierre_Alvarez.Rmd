...
```
Observamos que las variables mas importances son (24 variables):
> fe_lonlat, waterpoint_type_catP, quantity_catP, region_catP, lga_catP, extraction_type_class_catP, amount_tsh, funder_catP, payment_type_catP, district_code, extraction_type_group_catP, scheme_name_catP, extraction_type_catP, gps_height, basin_catP, ward_catP, fe_dianum, source_catP, installer_catP, fe_mes, region_code, population, fe_anio, source_class_catP
